...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.TrustRoot, desiredFinalizers sets.Set[string]) (*v1alpha1.TrustRoot, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.TrustRoot, desiredFinalizers sets.Set[string]) (*v1alpha1.TrustRoot, error) {
	// Don't modify the informers copy.
