...
cosign attest --use-signing-config=false --new-bundle-format=false --predicate ./predicate-file-custom-fails --fulcio-url ${FULCIO_URL} --rekor-url ${REKOR_URL} --allow-insecure-registry --yes ${demoimage} --identity-token ${OIDC_TOKEN}
...
cosign attest --use-signing-config=false --new-bundle-format=false --predicate ./predicate-file-custom-works --fulcio-url ${FULCIO_URL} --rekor-url ${REKOR_URL} --allow-insecure-registry --yes ${demoimage} --identity-token ${OIDC_TOKEN}
...
COSIGN_PASSWORD="" cosign sign --use-signing-config=false --new-bundle-format=false --key cosign.key --yes --allow-insecure-registry --rekor-url ${REKOR_URL} ${demoimage}
echo '::endgroup::'
